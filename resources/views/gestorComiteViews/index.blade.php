                                ...
                                <tr class="bg-white border-b">
                                    ...
                                    @can('administrar')
                                        <td class="px-6 py-4 ">
                                            ...
                                            <x-link
                                                href="{{ route('gestorComiteViews.detalles', ['solicitud' => $solicitud->id]) }}">Detalles

                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-10 w-10 transition duration-150 ease-in-out" viewBox="0 0 20 20"
                                                fill="currentColor">
                                                <path class="w-5 h-5 text-green-500"
                                        ...
                                        <td class="px-6 py-4">
                                            <button>
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    class="h-10 w-10 m-8 transition duration-75" viewBox="0 0 20 20"
                                                    fill="currentColor">
                                                    <path fill-rule="evenodd" class="flex-shrink-0 w-5 h-5 text-red-500"
