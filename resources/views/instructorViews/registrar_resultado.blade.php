    ...
    <div class="py-12 ">
        <div class="bg-green-50 shadow-x ">
            <div class="max-w-3x1 mx-auto p-6 mt-10">
                ...
                <x-link id="registrarResultadoLink" href="#" class="mx-3 bg-green-700 hover:bg-green-500 border-2 border-green-950">Registrar Resultado</x-link>
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        registrarResultadoLink.addEventListener("click", function(e) {
                            e
                        .preventDefault(); // Previene el comportamiento predeterminado del enlace (navegar a otra página)
                ...
                <x-link href="{{ url()->previous() }}" class="mx-3 bg-green-700 hover:bg-red-800 border-2 border-green-950">Cancelar</x-link>
