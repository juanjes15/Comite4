    ...
    <div class="bg-green-50 shadow-x " >
        <div class="max-w-3x1 mx-auto p-4 mt-10">
            ...
            <div class="max-w-3x1 mx-auto p-5 mt-10">
                ...
                <form class="flex items-center mb-10" method="GET" action="{{ route('consultar_comite') }}">
                    @csrf
                    ...
                    <table class="w-full text-sm text-left text-gray-500 ">
                        ...
                        <tbody>
                            <tr class="bg-white border-b ">
                                ...
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">
                                    <x-link href="{{ route('instructorViews.detalles_comite') }}" class="mx-3 mt-5 mb-6  mt-6 bg-green-700 hover:bg-yellow-500 border-2 border-green-950">Detalles</x-link>
                                </td>
                            </tr>
                        </tbody>
                    </table>
