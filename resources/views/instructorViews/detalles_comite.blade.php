    ...
    <div class="py-12">
        ...
        <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <td scope="col" class="px-6 py-3">
                <x-link href="{{ route('instructorViews.registrar_novedad2', ['sol_id' => $solicitud->id]) }}"
                    class="mx-3 bg-green-700 hover:bg-red-800 border-2 border-green-950">Registrar
                    novedades</x-link><!-- Agrega aquí el código para las acciones de administrar -->
            </td>
