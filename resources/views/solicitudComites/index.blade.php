                            ...
                            @forelse ($solicitudComites as $solicitudComite)
                                <tr class="bg-white border-b ">
                                    ...
                                    @can('administrar')
                                        ...
                                        <td>
                                            <button>
                                                <x-link href="{{ route('solicitudComites.show', $solicitudComite) }}">
                                        ...
                                        <td class="text-center">
                                            <button>
                                                <x-link href="{{ route('solicitudComites.show', $solicitudComite) }}">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-white dark:text-white" viewBox="0 0 20 20" fill="currentColor">
