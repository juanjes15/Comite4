<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-[#39a900] border-r-2 border-black sm:translate-x-0"
    aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto bg-gradient-to-b from-[#39a900] to-green-50">
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('instructorViews.solicitar1') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    <svg class="w-5 h-5 text-gray-50 transition duration-75 group-hover:text-gray-900" aria-hidden="true"
            ...
            <li>
                <a href="{{ route('aprendiz_Views.impugnaciones') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">impugnaciones</span>
                </a>
            </li>
            <li>
                <a href="{{ route('aprendiz_Views.reglamento') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                        <path
                            d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z" />
                    </svg>
                    <span class="flex-1 ml-3 whitespace-nowrap">Reglamento</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ asset('storage/ReglamentoAprendiz_SENA.pdf') }}" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Descargar Reglamento aprendiz</span>
                </a>
            </li>
            <!-- CRUD'S -->
            <li>
