            ...
            <div class="container mx-auto p-6">
                ...
                <form method="post" action="{{ route('aprendiz_Views.reglamento') }}" class="mb-12">
                    ...
                    <div class="mb-4">
                        ...
                        <select
                            class="w-full p-2 border rounded-lg shadow-md focus:outline-none focus:ring focus:border-blue-500"
                            name="opcion">
                    ...
                    <button type="submit"
                        class="bg-blue-500 hover:bg-blue-600 text-white py-3 px-6 rounded-lg text-lg transition duration-300 transform hover:scale-105">Buscar</button>
                </form>
                ...
                <div class="text-center">
                    <a href="{{ asset('storage/resultados.pdf') }}" download="resultados.pdf"
                        class="bg-blue-500 hover:bg-blue-600 text-white py-3 px-6 rounded-lg text-lg transition duration-300 transform hover:scale-105 inline-block mt-4">
