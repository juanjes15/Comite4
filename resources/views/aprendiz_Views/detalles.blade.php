    ...
    <div class="max-w-3xl mx-auto p-6 bg-green-50 shadow-xl rounded-lg">
        ...
        <div class="flex flex-wrap -mx-4 mb-4">
            <div class="w-1/2 px-4 mb-4">
                ...
                <input type="text" class="mt-1 p-2 w-full border rounded-md focus:ring focus:ring-blue-400" readonly
                    value="7528292">
            </div>

            <div class="w-1/2 px-4 mb-4">
                <label class="block text-sm font-medium text-gray-700">Fecha</label>
                <input type="date" class="mt-1 p-2 w-full border rounded-md focus:ring focus:ring-blue-400" readonly
                    value="2023-09-01">
            </div>
            ...
            <div class="w-1/2 px-4 mb-4">
                ...
                <select name="instructor_id" class="mt-1 p-2 w-full border rounded-md focus:ring focus:ring-blue-400"
                    ...
                    @foreach ($instructors as $instructor)
                        <option value="{{ $instructor->id }}" disabled>{{ $instructor->ins_nombres }}
