                ...
                <div class="bg-green-50 shadow-xl px-1 py-12 rounded mt-8">
                    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        <div class="container mx-auto mt-8">
                            <form class="mt-4" action="{{ route('aprendiz_Views.impugnaciones') }}" method="POST"
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="apr_identificacion" id="identificacion"
                                        class="w-full px-4 py-2 border rounded" required pattern="[0-9]+">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="apr_motivoImpugnacion" id="motivo_impugnacion"
                                        class="w-full px-4 py-2 border rounded" rows="4" required></textarea>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="apr_pruImpugnacion" type="file" name="apr_pruImpugnacion" accept="image/*"
                                        required>
                                ...
                                <div class="mb-1 mt-6">
                                    ...
                                    <a href=""
                                        class="px-3 py-1 ml-3 bg-green-700 hover:bg-red-800 border-2 border-green-950 border rounded">
