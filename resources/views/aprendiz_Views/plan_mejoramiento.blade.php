            ...
            <div class="max-w-3xl mx-auto p-6">
                ...
                <div class="flex mb-4">
                    <div class="w-1/2 mr-2">
                        ...
                        <input type="text" class="mt-1 p-2 w-full border rounded-md" value="{{ $planMejoramiento->Fecha_inicial }}" readonly>
                    </div>

                    <div class="w-1/2 mr-2">
                        <label class="block text-sm font-medium text-gray-700">Fecha Final</label>
                        <input type="text" class="mt-1 p-2 w-full border rounded-md" value="{{ $planMejoramiento->Fecha_final }}" readonly>
                    </div>
                </div>

                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">Instructor Responsable</label>
                    <input type="text" class="mt-1 p-2 w-full border rounded-md" value="{{ $planMejoramiento->Instructor_responsable }}" readonly>
                </div>

                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">Objetivo del Plan</label>
                    <textarea class="mt-1 p-2 w-full border rounded-md" rows="4" readonly>{{ $planMejoramiento->Objetivo_del_plan }}</textarea>
                </div>

                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700">Indicadores de Desempeño</label>
                    <textarea class="mt-1 p-2 w-full border rounded-md" rows="4" readonly>{{ $planMejoramiento->Indicadores_de_desempeno }}</textarea>
                </div>
