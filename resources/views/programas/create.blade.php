                    ...
                    <form method="POST" action="{{ route('programas.store') }}">
                        ...
                        <div>
                            ...
                            <x-input id="pro_codigo" class="block mt-1 w-full" type="text" name="pro_codigo"
                                :value="old('pro_codigo')" required autofocus autocomplete="pro_codigo" />
                        </div>
                        <div>
                            <x-label for="pro_nombre" value="{{ __('Nombre') }}" />
                            <x-input id="pro_nombre" class="block mt-1 w-full" type="text" name="pro_nombre"
                                :value="old('pro_nombre')" required autofocus autocomplete="pro_nombre" />
                        </div>
                        <div>
                            ...
                            <x-input id="pro_nivelFormacion" class="block mt-1 w-full" type="text"
                                name="pro_nivelFormacion" :value="old('pro_nivelFormacion')" required autofocus
