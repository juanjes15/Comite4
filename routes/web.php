...
Route::middleware([
    ...
    Route::middleware('checkUserRole:Instructor,Administrador')->group(function () {
        ...
        Route::post('/InstructorViews/registrar_novedad5/{sol_id}', [\App\Http\Controllers\InstructorViewController::class, 'storeRegistrar_novedad5'])->name('instructorViews.storeRegistrar_novedad5');
